...
export const UserRoleEnum = pgEnum('user_role', [UserRoles.ADMIN, UserRoles.MANAGER, UserRoles.DOCTOR, UserRoles.PHARMACIST, UserRoles.RECEPTIONIST, UserRoles.LAB_TECHNICIAN, UserRoles.BILLING]);
export const UserStatusEnum = pgEnum('user_status', [UserStatus.ACTIVE, UserStatus.INACTIVE, UserStatus.SUSPENDED, UserStatus.LEAVE]);
